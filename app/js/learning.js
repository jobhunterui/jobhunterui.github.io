...
const LearningDashboard = (function() {
    ...
    function exportPlanAsPdf() {
        ...
        showModal('Export as PDF', 'This feature will generate a PDF of your learning plan with current progress. Continue?', [
            {
                id: 'cancel-export',
                text: 'Cancel',
                class: 'secondary-button'
            },
            {
                ...
                action: function() {
                    ...
                    alert('PDF export feature will be implemented in the next update.');
                    
                    // Track export action
                    if (typeof trackEvent === 'function') {
                        trackEvent('learning_plan_export_pdf');
                    }
                }
            }
        ]);
    ...
    function sharePlan() {
        ...
        showModal('Share Learning Plan', 'How would you like to share your learning plan?', [
            {
                id: 'share-json',
                text: 'Copy JSON',
                class: 'primary-button',
                action: function() {
                    ...
                    const jsonString = JSON.stringify(currentPlan);
                    copyToClipboard(jsonString)
                        .then(() => {
                            alert('Learning plan JSON copied to clipboard!');
                        })
                        .catch(err => {
                    ...
                    // Track share action
                    if (typeof trackEvent === 'function') {
                        trackEvent('learning_plan_share_json');
                    }
                }
            },
            {
                ...
                action: function() {
                    ...
                    alert('Link sharing feature will be implemented in the next update.');
                    
                    // Track share action
                    if (typeof trackEvent === 'function') {
                        trackEvent('learning_plan_share_link');
                    }
                }
            }
        ]);
